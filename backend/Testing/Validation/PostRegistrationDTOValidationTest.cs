...
namespace Testing.Validation
{
    ...
    {
        private readonly PostRegistrationDTO _postRegistrationDTO;

        public PostRegistrationDTOValidationTest()
        {
            _postRegistrationDTO = new PostRegistrationDTO
            {
                UserId = 1,
                Text = "Sample text",
                Pictures = null
        ...
        {
            _postRegistrationDTO.Pictures = new List<PictureRegistrationDTO> { new() };
