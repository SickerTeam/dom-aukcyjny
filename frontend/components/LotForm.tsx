      ...
      <Form>
        ...
        {saleType === "auction" && ( // display auction related inputs
          <>
            ...
            <Field type="datetime-local" id="endsAt" name="endsAt" />
            <ErrorMessage name="endsAt" component="div" />

            <label htmlFor="startingPrice">Starting Price</label>
            <Field type="number" id="startingPrice" name="startingPrice" />
            <ErrorMessage name="startingPrice" component="div" />

            <label htmlFor="minimumPrice">Minimum Price</label>
            <Field type="number" id="minimumPrice" name="minimumPrice" />
        ...
        <Field type="text" id="product.artist" name="product.artist" />
